...
Write-Host "Waiting for notification-service (20s)..." -ForegroundColor Gray

Start-Sleep -Seconds 20



Write-Host "Step 4: Starting identity-service (profile=local, port 8081)..." -ForegroundColor Cyan
